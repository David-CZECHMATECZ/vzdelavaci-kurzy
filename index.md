...
7. Vizualizace dat:
	- *nástroje pro vizualizaci a analýzu dat získaných online*
8. Etika a soukromí při vyhledávání:
	- *diskuse o etických a soukromích aspektech online vyhledávání*
9. Praktické cvičení:
	- *řešení reálných úkolů spojených s vyhledáváním a analýzou dat*
10. Závěrečný projekt:
	- *praktická aplikace naučených dovedností na konkrétním případu*
- ### *Možnosti pracovního uplatnění*
	- Kurz připraví absolventy na práci: 
		- *analytika v moha oborech, který informace efektivně:*
			- *vyhledává*
			- *analyzuje*
			- *interpretuje*
- ### *Volné termíny*
	- *11.12.2023 - 20.12.2023* (dopoledne)
	- *11.12.2023 - 20.12.2023* (odpoledne)
- ### Cena - *9 600 Kč*
- ### Cena s příspěvkem od Úřadu práce ČR - [*1 728 Kč*](https://www.uradprace.cz/web/cz/vyhledani-rekvalifikacniho-kurzu?typKurzu=1.4)
- - -
...
- ### *Sylabus kurzu*
1. Základy kybernetiky:
	- *seznámení s principy kybernetiky a její rolí v digitálním světě*
2. Bezpečnostní postupy:
	- *ochrana osobních údajů a zařízení skrze základní bezpečnostní opatření*
3. Internetová gramotnost:
	- *vyhledávání*
	- *hodnocení zdrojů*
	- *práce s online informacemi*
4. Základy programování:
	- *úvod do programování a algoritmického myšlení*
5. Digitální komunikace:
	- *efektivní komunikace přes digitální kanály a sociální média*
6. Práce s daty:
	- *získávání, analýza a vizualizace základních datových sad*
7. Základy kyberbezpečnosti:
	- *rozpoznání a prevence online hrozeb*
8. Digitální tvorba obsahu:
	- *tvorba textu, obrázků a videí pro digitální média*
9. E-etika a právní aspekty:
	- *etické a právní záležitosti v digitálním prostředí*
10. Budoucnost digitálního světa:
	- *pohled na nadcházející technologické trendy a jejich dopad*
- ### *Možnosti pracovního uplatnění*
	- Absolventi kurzu se uplatní v oborech vyžadujících kybernetickou zdatnost.
		- *IT firmy*
		- *bezpečnostní firmy*
		- *digitální marketing*
		- *komunikace*
...
1. Úvod do OSINT a kybernetické bezpečnosti:
	...
	- *význam OSINT v moderní digitální bezpečnosti*
